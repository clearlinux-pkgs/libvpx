...
Source0  : https://github.com/webmproject/libvpx/archive/v1.9.0/libvpx-1.9.0.tar.gz
...
%prep
%setup -q -n libvpx-1.9.0
cd %{_builddir}/libvpx-1.9.0
%patch1 -p1
pushd ..
cp -a libvpx-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596213281
...
cp %{_builddir}/libvpx-1.9.0/LICENSE %{buildroot}/usr/share/package-licenses/libvpx/4dbe7c1f3a1833a88333a7c282119323e9ef44fa
cp %{_builddir}/libvpx-1.9.0/third_party/googletest/src/LICENSE %{buildroot}/usr/share/package-licenses/libvpx/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/libvpx-1.9.0/third_party/libwebm/LICENSE.TXT %{buildroot}/usr/share/package-licenses/libvpx/59cd938fcbd6735b1ef91781280d6eb6c4b7c5d9
cp %{_builddir}/libvpx-1.9.0/third_party/libyuv/LICENSE %{buildroot}/usr/share/package-licenses/libvpx/f71908f9aaa4aee0f15f9983b6cf83791d18cfd7
cp %{_builddir}/libvpx-1.9.0/third_party/x86inc/LICENSE %{buildroot}/usr/share/package-licenses/libvpx/697c7d5a9839cf4160acd85431b0c58be874dba8
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
...
/usr/lib64/haswell/libvpx.so.6.3
/usr/lib64/haswell/libvpx.so.6.3.0
