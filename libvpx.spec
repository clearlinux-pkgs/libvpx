...
Source0  : https://github.com/webmproject/libvpx/archive/v1.14.1/libvpx-1.14.1.tar.gz
...
%prep
%setup -q -n libvpx-1.14.1
cd %{_builddir}/libvpx-1.14.1
%patch -P 1 -p1
pushd ..
cp -a libvpx-1.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717429149
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvpx.so.9.0.1
/usr/lib64/libvpx.so.9
/usr/lib64/libvpx.so.9.0
/usr/lib64/libvpx.so.9.0.1
