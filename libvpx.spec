...
Source0  : https://github.com/webmproject/libvpx/archive/v1.15.0/libvpx-1.15.0.tar.gz
...
%prep
%setup -q -n libvpx-1.15.0
cd %{_builddir}/libvpx-1.15.0
%patch -P 1 -p1
pushd ..
cp -a libvpx-1.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730498789
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvpx.so.9.1.0
/usr/lib64/libvpx.so.9
/usr/lib64/libvpx.so.9.1
/usr/lib64/libvpx.so.9.1.0
